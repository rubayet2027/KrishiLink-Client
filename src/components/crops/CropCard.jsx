...
const CropCard = ({ crop }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-md overflow-hidden card-hover">
      ...
      {/* Content */}
      <div className="p-5">
        <h3 className="text-xl font-bold text-gray-800 mb-3 truncate">{cropName}</h3>
        ...
        <div className="space-y-2 mb-4">
          ...
          <div className="flex items-center gap-2 text-gray-600">
            ...
            <span className="text-sm">
              Harvest: {new Date(harvestDate).toLocaleDateString('en-US', {
                month: 'short',
                day: 'numeric',
                year: 'numeric'
              })}
        ...
        <div className="flex items-center gap-3 pt-4 border-t">
          ...
          <span className="text-sm text-gray-600 truncate flex-1">{ownerName}</span>
        </div>
