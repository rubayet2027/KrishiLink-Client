          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {activeTab === 'details' && (
              <div className="bg-white rounded-xl shadow-md p-6">
                <h1 className="text-3xl font-bold text-gray-800 mb-4">{crop.cropName}</h1>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                  <div className="bg-green-50 p-4 rounded-lg">
                    ...
                    <p className="text-2xl font-bold text-gray-800">৳{crop.pricePerUnit}</p>
                  </div>
                  ...
                  <div className="bg-amber-50 p-4 rounded-lg">
                    ...
                    <p className="text-2xl font-bold text-gray-800">{crop.quantity}</p>
                  </div>
                  ...
                  <div className="bg-purple-50 p-4 rounded-lg">
                    ...
                    <p className="text-lg font-bold text-gray-800 truncate">{crop.location}</p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="flex items-center gap-4 mb-4">
                {crop.ownerPhoto ? (
                  ...
                  <div className="w-16 h-16 rounded-full bg-green-100 flex items-center justify-center text-green-600 text-2xl font-bold">
                    {crop.ownerName?.charAt(0)}
                  </div>
                )}
                <div>
                  <p className="font-bold text-gray-800">{crop.ownerName}</p>
              ...
              <div className="space-y-3 text-gray-600">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm break-all">{crop.ownerEmail}</span>
                </div>
                {crop.ownerPhone && (
                  <div className="flex items-center gap-3">
                    <HiPhone className="text-green-600 text-lg" />
                    <span className="text-sm">{crop.ownerPhone}</span>
                  </div>
                )}
                <div className="flex items-center gap-3">
